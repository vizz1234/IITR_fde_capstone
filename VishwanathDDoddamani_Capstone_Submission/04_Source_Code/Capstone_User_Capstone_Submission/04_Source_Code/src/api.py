...
# Prometheus Metrics
TICKETS_TOTAL = Counter("tickets_processed_total", "Total tickets processed", ["channel", "outcome"])
LATENCY = Histogram("ticket_processing_latency_seconds", "End-to-end processing latency")
GUARDRAIL_BLOCKS = Counter("guardrail_blocks_total", "Responses blocked by guardrails", ["guardrail_type"])
